                ...
                <View style={styles.UpcomingViews}>
                    ...
                    <View style={styles.timeViews}>
                        ...
                        <View 
                            ...
                            <Text style={styles.timeText}>Canceled</Text>
                        </View>
                    </View>
                    ...
                    <TouchableOpacity style={styles.RescheduleButtonsContainer}>
                        ...
                        <TouchableOpacity style={styles.CancelButtonsContainer} disabled>
                            <Text style={{fontSize:18, color:'#3A4255'}}>Confirmed</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
