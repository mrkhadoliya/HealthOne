...
import appointmentImage from "../../Assets/DateImage/book-appointment.png";
import editImage from "../../Assets/DateImage/edit.png";
            ...
            <SafeAreaView>
                ...
                <View style={styles.ChangesContainer}>
                    <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingBottom: 10 }}>
                        <View>
                            <Text style={{ color: "#fff", fontSize: 18, fontWeight: "500" }}>Date</Text>
                        </View>
                        <View>
                            <TouchableOpacity activeOpacity={0.7}>
                                <Text style={{ color: "#A1A8B0", fontSize: 15, fontWeight: "400" }}>Change</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                        <View>
                            <TouchableOpacity activeOpacity={0.7} style={styles.appointmentImages}>
                                <Image source={appointmentImage} style={{ width: "100%", height: "100%", resizeMode: "contain", transform: [{ scale: 1.6 }] }} />
                            </TouchableOpacity>
                        </View>
                        <View>
                            <TouchableOpacity>
                                <Text style={{ color: "#A1A8B0", fontSize: 15, fontWeight: "500", letterSpacing: 0.4 }}>Friday, April 21, 2023 | 02:45 PM</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
                <View style={styles.ChangesContainer}>
                    <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingBottom: 10 }}>
                        <View>
                            <Text style={{ color: "#fff", fontSize: 18, fontWeight: "500" }}>Reason</Text>
                        </View>
                        <View>
                            <TouchableOpacity activeOpacity={0.7}>
                                <Text style={{ color: "#A1A8B0", fontSize: 15, fontWeight: "400" }}>Change</Text>
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                        <View>
                            <TouchableOpacity activeOpacity={0.7} style={styles.appointmentImages}>
                                <Image source={editImage} style={{ width: "100%", height: "100%", resizeMode: "contain", transform: [{ scale: 1.4 }] }} />
                            </TouchableOpacity>
                        </View>
                        <View>
                            <TouchableOpacity>
                                <Text style={{ color: "#A1A8B0", fontSize: 15, fontWeight: "500", letterSpacing: 0.4 }}>Chest pain</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
                        ...
                        <View style={styles.centeredView}>
                            <View style={styles.modalView}>
                                ...
                                <Pressable style={[styles.button, styles.buttonClose]} onPress={() => setModalVisible(!modalVisible)}>
                                    <Text style={styles.textStyle}>Chat Doctor</Text>
                                </Pressable>
                            </View>
                        </View>
                    </Modal>
